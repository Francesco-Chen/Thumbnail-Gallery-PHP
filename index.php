...
<html lang="en">
  ...
  <body>
    <div>
      ...
      $galleryDir = "gallery/";
      $thumbDir = "thumb/";
      $allowedExtensions = array("jpg", "jpeg", "png", "gif", "webp"); // Add webp format to the allowed extensions
      ...
      foreach ($galleryFiles as $file) {
          ...
          if (in_array(strtolower($extension), $allowedExtensions)) {
              ...
              // If the image is in webp format, skip creating a thumbnail and use the original image
